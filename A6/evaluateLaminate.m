function [maxstress_Rmin, quad_Rmin, hashin_Rmin, mass] = evaluateLaminate(material_string, schedule, z_c, M_i, N_i, L, W)

% ================================== INPUTS ==================================

[E_x, E_y, E_s, nu_x, nu_y, m, X_t, X_c, Y_t, Y_c, S_c, h_o, rho] = getProperties("material_database.json", material_string);
...
hashin_Rmin = min_R_hashin;
mass = rho.value * (length(schedule) * 2) * h_o.value * L * W * 1000;
